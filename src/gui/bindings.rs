...
pub static BINDINGS: Lazy<Vec<Category>> = Lazy::new(|| {
    ...
    vec![
        ...
        Category {
            ...
            entries: vec![
                Entry {
                    id: MoveToWorkspaceLeft,
                    label: "Move To Workspace Left",
                    binding: vec![Op::key(
                        true,
                        vec![Const(MOD_Super), Const(MOD_Alt), Const(KEY_Left)],
                    )],
                    keybind: Some("Super+Alt+Left"),
                },
                Entry {
                    id: MoveToWorkspaceRight,
                    label: "Move To Workspace Right",
                    binding: vec![Op::key(
                        true,
                        vec![Const(MOD_Super), Const(MOD_Alt), Const(KEY_Right)],
                    )],
                    keybind: Some("Super+Alt+Right"),
                },
                Entry {
                ...
                Entry {
                    id: LastWorkspaceWindow,
                    label: "Last Workspace Window",
                    binding: vec![Op::key(true, vec![Const(MOD_Alt), Const(KEY_Esc)])],
                    keybind: Some("Alt+Escape"),
                },
                Entry {
                    id: EscKey,
                    label: "Escape Key",
                    binding: vec![Op::key(true, vec![Const(KEY_Esc)])],
                    keybind: Some("Escape"),
                },
                Entry {
                    id: ShowLauncher,
